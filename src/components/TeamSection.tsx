  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1200px] mx-auto px-6 md:px-8">
        <div
          className={`text-center max-w-[500px] mx-auto mb-16 fade-in-up ${visible ? 'visible' : ''}`}
        >
          <span className="text-[#C8956C] text-[12px] font-inter font-medium tracking-[0.12em] uppercase">
            Tim Pengembang
          </span>
          <h2 id="team-heading" className="mt-4 text-white font-crimson-text text-[36px] md:text-[48px] font-bold leading-[1.1]">
            Meet Team
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {teamMembers.map((member, i) => (
            <div
              key={member.name}
              className={`group relative p-6 rounded-[14px] border border-white/5 bg-white/[0.015] hover:bg-white/[0.03] hover:border-white/10 transition-colors duration-300 fade-in-up ${visible ? 'visible' : ''}`}
              style={{
            ...
            >
              ...
              <div className="mt-5 pt-4 border-t border-white/5 flex items-center gap-3">
                <a
                  ...
                  className="text-[#777] hover:text-[#999] transition-colors"
